...
def experimental_design_1(fname_suffix, outfile_name, TRUE_K):
...
def experimental_design_2(fname_suffix, outfile_name, TRUE_K, k_list):
    # let's get summarized results for different detection algorithm
    all_outputs = []
...
if __name__ == "__main__":
    ...
    #     TRUE_K=5,
    # )
    experimental_design_2(
        fname_suffix="n2500",
        outfile_name="n2500_detections_kadane.csv",  # use a different naming pattern
        TRUE_K=5,
        k_list=[6, 8, 10, 15, 20],
    )
